...
1. Execute `gradle setupDecompWorkspace`. This sets up Forge and downloads the necessary libraries to build ArmorStatusHUD. This might take some time, be patient.
